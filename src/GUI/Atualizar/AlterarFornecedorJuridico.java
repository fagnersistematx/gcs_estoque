 ...
 * @version 1.0
 */
public class AlterarFornecedorJuridico extends javax.swing.JDialog {
    ...
    public AlterarFornecedorJuridico(java.awt.Frame parent, PesquisaFornecedor pesquisaFornecedor, Long codigo) {
        super(parent);
        initComponents();
        this.codigo = codigo;
    ...
    private void initComponents() {
        ...
        setTitle("Atualizar dados Fornecedor - Jurídico");
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        boolean cond = fornecedorController.atualizarDadosFornecedorJuridico(fornecedor, tfNome.getText(), tfRazao_Social.getText(), tfSite.getText(), tfMail.getText(),
    ...
    private void mostrarDados() {
        try {
            ...
            tfCNPJ.setText(fornecedor.getCpf_cnpj());
