...
public class CadastrarFuncionario extends javax.swing.JDialog {
    ...
    public CadastrarFuncionario(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Cadasto de Funcionário");
...
private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
    ...
    if (senha.equalsIgnoreCase(tfSenha.getText().toString())) {
        ...
        boolean cond = funcionarioController.CadastrarFuncionario(tfNome.getText(), tfLogin.getText(), tfSenha.getText(), tfMail.getText(),
